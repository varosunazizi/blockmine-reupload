...
stamina.settings = {
	...
	sprint_lvl = get_setting("sprint_lvl", 0.1),
	sprint_speed = get_setting("sprint_speed", 0.2),
	sprint_jump = get_setting("sprint_jump", 0.1),
	sprint_with_fast = minetest.settings:get_bool("stamina.sprint_with_fast", false),
	tick = get_setting("tick", 100),
	tick_min = get_setting("tick_min", 4),
	health_tick = get_setting("health_tick", 0.2),
	move_tick = get_setting("move_tick", 0.2),
	poison_tick = get_setting("poison_tick", 1.0),
	exhaust_dig = get_setting("exhaust_dig", 2),
	exhaust_place = get_setting("exhaust_place", 1),
	exhaust_move = get_setting("exhaust_move", 0.2),
	exhaust_jump = get_setting("exhaust_jump", 0.2),
	exhaust_craft = get_setting("exhaust_craft", 20),
	exhaust_punch = get_setting("exhaust_punch", 40),
	exhaust_sprint = get_setting("exhaust_sprint", 0.2),
